...
const features = [
  {
    number: "01",
    title: "75–83% Flawed",
    description: "75–83% of AI-generated code contains security flaws.",
    visual: "ai",
  },
  {
    number: "02",
    title: "1 in 3 Vulnerable",
    description: "1 in 3 applications ships with critical vulnerabilities.",
    visual: "security",
  },
  {
    number: "03",
    title: "Zero Full Audits",
    description: "Most LLM-generated code is never fully security reviewed.",
    visual: "deploy",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            AI writes code fast.
            <br />
            <span className="text-muted-foreground">It also writes bugs fast.</span>
          </h2>
        </div>
